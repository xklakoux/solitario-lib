...
public abstract class BasePile extends RelativeLayout implements OnDragListener{
	...
	//	private StackingColor stackingColor;
	//	private StackingRank stackingRank;
	//	private StackingStyle stackingStyle;
	//	private EmptyPileBehavior 
	...
	public boolean checkState(boolean animation) {
		return true;
	}
